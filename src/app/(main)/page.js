...
import goldenArrow from '../../../public/media/images/arrowGolden.svg';
import icon1 from '../../../public/media/images/icon/icon1.svg';
import icon2 from '../../../public/media/images/icon/icon2.svg';
import icon3 from '../../../public/media/images/icon/icon3.svg';
import icon4 from '../../../public/media/images/icon/icon4.svg';

import logo1 from '../../../public/media/img/logos/logo1.svg';
import logo2 from '../../../public/media/img/logos/logo2.svg';
import logo3 from '../../../public/media/img/logos/logo3.svg';
import logo4 from '../../../public/media/img/logos/logo4.svg';
import logo5 from '../../../public/media/img/logos/logo5.svg';
        ...
        <article className="experience">
          <div className="marquee-block">
            <div className="marquee-container">
              <div className="marquee">Universal School of Pharmacovigilance & Medical affairs</div>
            </div>
          </div>
