        ...
        translation: {
          levels: {
            ...
            beginner: {
              ...
              text2:
                "Interest and motivation to master a new specialty in this field",
            },
            elementary: {
              text1:
                "There is an understanding of the concept of pharmacovigilance",
              text2: "Experience in building a pharmacovigilance system",
              text3:
                "Motivation for development and career growth in a pharmaceutical company",
            },
            intermediate: {
              text1: "Knowledge and experience in pharmacovigilance",
              text2:
                "Ability to present and/or evaluate a pharmacovigilance system",
              text3:
            ...
            advanced: {
              ...
              text3:
                "Willingness to implement the best pharmacovigilance practices",
            },
            specialized: {
              text1: "Knowledge of key aspects of pharmacovigilance",
              text2:
                "Interest in individual, highly specialized pharmacovigilance topics",
              text3:
          ...
          home: {
            ...
            plitc: {
              ...
              subtext1:
                "We provide access to the latest knowledge and practical tools",
              text2: "Expert teachers and leading schools",
              subtext2:
                "We cooperate with leading international experts in their field",
          ...
          aboutCompany: {
            hero: {
              ...
              text3:
                "Join us and move forward towards professional growth and improvement.",
            },
            partner: {
              text1:
            ...
            services: {
              ...
              text4: "Training",
              text5:
                "Training on the platform helps optimize work processes and methods",
              text6: "Audits",
              text7:
          ...
          cabinet: {
            ...
            downloadLecture: "Open Google Classroom ",
          ...
          additional: {
            ...
            contacts: "Contacts",
            contactsDescription:
              "You can send your email address and we will get back to you.",
          ...
          blogCard: {
            post0: {
              title: "1Drug safety: How to choose a reliable manufacturer?",
              excerp:
            ...
            post1: {
              title: "2Drug safety: How to choose a reliable manufacturer?",
              excerp:
                "When choosing medications, safety and reliability should come first. IN In this article we will tell you what to look for when choosing a manufacturer medications, how to check product quality and what GMP certification means.",
            ...
            post2: {
              title: "3Drug safety: How to choose a reliable manufacturer?",
              excerp:
                "When choosing medications, safety and reliability should come first. IN In this article we will tell you what to look for when choosing a manufacturer medications, how to check product quality and what GMP certification means.",
              time: "July 6, 2024",
              img: "../../../media/img/card-photo.png",
            ...
            post3: {
              title: "4Drug safety: How to choose a reliable manufacturer?",
              excerp:
                "When choosing medications, safety and reliability should come first. IN In this article we will tell you what to look for when choosing a manufacturer medications, how to check product quality and what GMP certification means.",
              time: "March 26, 2023",
              img: "../../../media/img/card-photo.png",
        ...
        translation: {
          levels: {
            ...
            beginner: {
              ...
              text2:
                "Интерес и мотивация к освоению новой специальности в данной сфере",
            },
            elementary: {
              text1: "Присутствует понимание понятия фармаконадзора",
              text2: "Опыт в построении системы фармаконадзора",
              text3:
                "Мотивация к развитию и карьерному росту в фармацевтической компании",
            },
            intermediate: {
              text1: "Знания и опыт работы в фармаконадзоре",
              text2:
                "Способность презентовать и/или оценить систему фармаконадзора",
              text3:
            ...
            specialized: {
              text1: "Знание ключевых аспектов фармаконадзора",
              text2:
                "Заинтересованность в отдельных, узкоспециализированных темах фармаконадзора",
              text3:
          ...
          servicesTopics: {
            ...
            topic2: {
              ...
              text6:
                "f. Возможность вашего фокусирования на основной деятельности",
            },
            topic3: {
              title: "Обучение ",
          ...
          aboutCompany: {
            ...
            partner: {
              text1:
                "Ваш партнер в мире фармацевтического образования и профессионального роста",
              text2:
            ...
            services: {
              ...
              text4: "ОБУЧЕНИЕ",
              text5:
                "Обучение на платформе помогает оптимизировать рабочие процессы и методы",
              text6: "АУДИТЫ",
              text7:
          ...
          toast: {
            message: {
              ...
              failed:
                "Не удалось отправить сообщение. Пожалуйста, повторите попытку позже",
            },
            login: {
          ...
          cabinet: {
            ...
            downloadLecture: "Открыть Google Classroom ",
          ...
          blogCard: {
            post0: {
              title:
                "1Безопасность лекарств: Как выбрать надежного производителя?",
              excerp:
            ...
            post1: {
              title:
                "2Безопасность лекарств: Как выбрать надежного производителя?",
              excerp:
                "При выборе медикаментов безопасность и надежность должны быть на первом месте. В этой статье мы расскажем, на что обращать внимание при выборе производителя лекарств, как проверять качество продукции и что означает сертификация GMP.",
            ...
            post2: {
              title:
                "3Безопасность лекарств: Как выбрать надежного производителя?",
              excerp:
                "При выборе медикаментов безопасность и надежность должны быть на первом месте. В этой статье мы расскажем, на что обращать внимание при выборе производителя лекарств, как проверять качество продукции и что означает сертификация GMP.",
              time: "6 июля, 2024",
              img: "../../../media/img/card-photo.png",
        ...
        translation: {
          levels: {
            ...
            beginner: {
              ...
              text2:
                "Зацікавлення та мотивація до освоєння нової спеціальності у цій сфері",
            },
            elementary: {
              text1: "Є розуміння поняття фармаконагляду",
              text2: "Досвід у побудові системи фармаконагляду",
              text3:
                "Мотивація до розвитку та кар'єрного зростання у фармацевтичній компанії",
            },
            intermediate: {
              text1: "Знання та досвід роботи у фармаконагляді",
              text2:
                "Здатність презентувати та/або оцінити систему фармаконагляду",
              text3:
            ...
            advanced: {
              ...
              text3:
                "Готовність до впровадження найкращих практик фармаконагляду",
            },
            specialized: {
              text1: "Знання ключових аспектів фармаконагляду",
              text2:
                "Зацікавленість в окремих, вузькоспеціалізованих темах фармаконагляду",
              text3:
          ...
          home: {
            ...
            plitc: {
              ...
              subtext1:
                "Ми забезпечуємо доступ до найсучасніших знань та практичних інструментів",
              ...
              subtext3:
                "Наше навчання включає практичні завдання, дискусії та інтерактивні вправи",
            },
            about: {
              text1: "Про нас",
              text2:
          ...
          aboutCompany: {
            ...
            partner: {
              text1:
                "Ваш партнер у світі фармацевтичної освіти та професійного зростання",
              text2:
            ...
            services: {
              ...
              text4: "Навчання",
              text5:
                "Навчання на платформі допомагає оптимізувати робочі процеси та методи",
              text6: "Аудити",
              text7:
          ...
          toast: {
            message: {
              ...
              failed:
                "Не вдалося надіслати повідомлення. Будь ласка, повторіть спробу пізніше",
            },
            login: {
          ...
          cabinet: {
            ...
            downloadLecture: "Відкрити Google Classroom ",
          ...
          additional: {
            ...
            fewParticipant: "3 та більше учасників",
            manyParticipant: "5 та більше учасників",
          ...
          blogCard: {
            post0: {
              title: "1Безпека ліків: Як обрати надійного виробника?",
              excerp:
                "1Під час вибору медикаментів безпека та надійність мають бути на першому місці. У цій статті ми розповімо, на що звертати увагу під час вибору виробника ліків, як перевіряти якість продукції та що означає сертифікація GMP.",
              time: "7 червня, 2024",
              img: "../../../media/img/card-photo.png",
            },
            post1: {
              title: "2Безпека ліків: Як обрати надійного виробника?",
              excerp:
                "2Під час вибору медикаментів безпека та надійність мають бути на першому місці. У цій статті ми розповімо, на що звертати увагу під час вибору виробника ліків, як перевіряти якість продукції та що означає сертифікація GMP.",
              time: "13 грудня, 2024",
              img: "../../../media/img/card-photo.png",
            },
            post2: {
              title: "3Безпека ліків: Як обрати надійного виробника?",
              excerp:
                "3Під час вибору медикаментів безпека та надійність мають бути на першому місці. У цій статті ми розповімо, на що звертати увагу під час вибору виробника ліків, як перевіряти якість продукції та що означає сертифікація GMP.",
              time: "6 липня, 2024",
              img: "../../../media/img/card-photo.png",
            },
            post3: {
              title: "3Безпека ліків: Як обрати надійного виробника?",
              excerp:
                "4Під час вибору медикаментів безпека та надійність мають бути на першому місці. У цій статті ми розповімо, на що звертати увагу під час вибору виробника ліків, як перевіряти якість продукції та що означає сертифікація GMP.",
              time: "26 березня, 2023",
              img: "../../../media/img/card-photo.png",
            },
          },
        },
