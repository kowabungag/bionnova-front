            ...
            en: {
                translation: {
                    ...
                    feedback: {
                        ...
                        text1: 'Our company is highly impressed by the level of expertise and professionalism that was provided to us during the audit of our pharmacovigilance system. We require that, thanks!',
                        author1: 'Anna S.',
                        text2: 'The practical courses exceeded my expectations! I recommend these courses to everyone who wants to deepen their knowledge and skills in the field of pharmacovigilance!',
                        author2: 'Dmitry P.',
                        text3: 'Thank you for the pharmacovigilance training course. Interacting with regulators during the training provided valuable insight into how the industry works in the real world. Thanks a lot!',
                        author3: 'Ekaterina M.',
                        text4: 'I started with a clean slate and now, having completed the pharmacovigilance educational program, I feel confident in my new profession. Thank you for the opportunity to restart my career!',
                        author4: 'Alexey K.',
                    },
                    home: {
                        hero: {
            ...
            ru: {
                translation: {
                    ...
                    feedback: {
                        ...
                        author1: 'Анна С.',
                        text1: 'Наша компания очень впечатлена уровнем экспертизы и профессионализмом, которые нам предоставили при аудите нашей системы фармаконадзора. Это именно то, что было нам нужно, спасибо!',
                        text2: 'Практические курсы превзошли мои ожидания! Рекомендую эти курсы всем, кто стремится углубить свои знания и умения в сфере фармаконадзора!',
                        author2: 'Дмитрий П.',
                        text3: 'Прошла курс обучения по фармаконадзору. Взаимодействие с регуляторами в процессе обучения это ценный взгляд на то, как работает отрасль в реальных условиях. Спасибо за возможность!',
                        author3: 'Екатерина М.',
                        text4: 'Я начала с чистого листа, и теперь, завершив обучающую программу по фармаконадзору, чувствую себя уверенно в новой профессии. Спасибо за возможность перезапустить свою карьеру!',
                        author4: 'Алексей К.',
                    },
                    home: {
                        hero: {
            ...
            ua: {
                translation: {
                    ...
                    feedback: {
                        ...
                        text1: 'Наша компанія надзвичайно вражена рівнем експертизи та професіоналізмом, які нам надали при аудиті нашої системи фармаконагляду. Це саме те, що нам було потрібно, раді співпраці!',
                        author1: 'Анна С.',
                        text2: 'Практичні курси перевершили мої очікування! Рекомендую ці курси всім, хто прагне поглибити свої знання та вміння у сфері фармаконагляду!',
                        author2: 'Дмитро П.',
                        text3: 'Дякую за курс навчання по фармаконагляду. Взаємодія з регуляторами в процесі навчання дала цінний погляд на те, як працює галузь у реальних умовах. Ще раз дякую за таку можливість!',
                        author3: 'Катерина М.',
                        text4: 'Я розпочала з чистого аркуша, і тепер, завершивши навчальну програму по фармаконагляду, відчуваю себе впевнено в новій професії. Дякую за можливість перезапустити свою кар\'єру!',
                        author4: 'Олексій К.',
                    },
                    home: {
                        hero: {
