      ...
      <div className="container d-block-md">
        <div className="footer__wrapper">
          <div className="footer__contacts">
            <a target="_blank" href="tel:+380953829264">
              +380 95 382 9264
            </a>
          ...
          <div className="footer__center">
            <div className="footer__social">
              ...
              <a target="_blank" href="https://www.youtube.com/channel/UC50lJttRfXcbkp8M1byrJ3A">
              ...
              <a target="_blank" href="https://www.facebook.com/profile.php?id=61555470371055">
          ...
          <div className="footer__end">
            <div className="footer__logo">
              <Logo className="inline-svg" alt="Logo Bioscience Innova" />
            </div>

            <div className="footer__copyright">
              <p className="footer__copyright_link">
                {' '}
                <Link target="_blank" href="/public-offer">
                  {t('additional.publicOffer')}
                </Link>
              </p>
              <p className="footer__copyright_link">
                {' '}
