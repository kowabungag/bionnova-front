      ...
      <div className={styles.root}>
        ...
        >
          {({
            ...
            <form className={styles.form} onSubmit={(event) => handleLogin(event, values)}>
              <div className={styles.formContainer}>
                <div className={styles.formBlock}>
                  <label className="text40" htmlFor="identifier">
                    {t('login.login')}
                  </label>
                  <input
                    className="text24"
                ...
                <div className={styles.formBlock}>
                  <label className="text40" htmlFor="password">
                    {t('login.password')}
                  </label>
                  <input
                    className="text24"
                  ...
                  <p className={styles.error}>
                    {errors.passwod && touched.passwod && errors.passwod}
                  </p>
                </div>
              </div>
